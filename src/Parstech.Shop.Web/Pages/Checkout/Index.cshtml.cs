...
namespace Shop.Web.Pages.Checkout
{
    ...
    public class IndexModel : PageModel
    {
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                switch (type)
                {
                    case 3:
                        ...
                        try
                        {
                            var activeTransaction = await _walletClient.GetActiveTransactionAsync(wallet.WalletId, typeName);
        ...
        public async Task<IActionResult> OnPostCalculateAghsat(long price, int transactionId, int month)
        {
            ...
            Response.Message = result.Message;
            Response.Object = new { MonthlyAmount = result.MonthlyAmount, TotalAmount = result.TotalAmount };
        ...
        {
            var result = await _orderCheckoutClient.CompleteOrderAsync(orderId, orderShippingId, payTypeId, transactionId, month);
