...
namespace Shop.Web.Pages.Admin.Products
{
    ...
    public class CreateOrUpdateModel : PageModel
    {
        ...
        [BindProperty] public Object ResultObject { get; set; } = new Object();
        ...
        [BindProperty] public CateguryObject categuryObject { get; set; } = new CateguryObject();
        ...
        //feutures
        [BindProperty] public List<PropertyDto> Properties { get; set; } = new List<PropertyDto>();
