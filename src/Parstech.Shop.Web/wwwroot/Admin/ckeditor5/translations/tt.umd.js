...
(e => {
    const {['tt']: {dictionary, getPluralForm}} = {
        "tt": {
            "dictionary": {
                "Words: %0": "",
                "Characters: %0": "",
                ...
                "MENU_BAR_MENU_FILE": "",
                "MENU_BAR_MENU_EDIT": "Редакцияләү",
                "MENU_BAR_MENU_VIEW": "",
                "MENU_BAR_MENU_INSERT": "Керт",
                ...
                "Subscript": "",
                "Superscript": "",
                "Italic text": "Курсив текст",
                "Move out of an inline code style": "",
                "Bold text": "Калын текст",
                "Underline text": "Ассызыклы текст",
                "Strikethrough text": "Сызылган текст",
                "Saving changes": "Үзгәрешләрне саклау",
                "Revert autoformatting action": "Автоматик форматлау гамәлләрен бетер",
                "Align left": "Сулга тигезлә",
                "Align right": "Уңга тигезлә",
                "Align center": "Үзәккә тигезлә",
                "Justify": "Tигезлә",
                "Text alignment": "Текстны тигезләү",
                "Text alignment toolbar": "Текстны тигезләү кораллары панеле"
            }, getPluralForm(n) {
                return 0;
            }
        }
