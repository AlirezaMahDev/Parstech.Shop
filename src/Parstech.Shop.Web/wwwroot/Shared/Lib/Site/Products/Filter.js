...
let url = "/products/filter/" + Filter.value + "/?handler=Data";
...
function GetStoreList() {
    $.ajax({
        ...
        success: function (response) {
            ...
            FilterName.innerText = response.object2;
