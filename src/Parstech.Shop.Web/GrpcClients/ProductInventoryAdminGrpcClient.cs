...
namespace Parstech.Shop.Web.GrpcClients
{
    public class ProductInventoryAdminGrpcClient : IProductInventoryAdminGrpcClient
    {
        ...
        {
            var request = new ProductStockPriceRequest
            {
                StockPrice = new ProductStockPriceDto { Id = stockPriceId }
            };
        ...
        public async Task<ResponseDto> QuickEditProductStockPriceAsync(int id, double price, double salePrice, int quantity, string userName = null)
        {
