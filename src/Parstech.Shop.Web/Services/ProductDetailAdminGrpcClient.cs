...
public class ProductDetailAdminGrpcClient : GrpcClientBase
{
    ...
    {
        return new() { Id = source.Id, Name = source.Name, PropertyCateguryId = source.PropertyCategoryId };
    }
    ...
    {
        return new() { Id = source.Id, Name = source.Name, Percent = source.Percent };
    }

    private BrandDto MapToBrandDto(Shared.Protos.Product.BrandDto source)
    {
        return new()
        {
            BrandId = source.Id,
    ...
    {
        return new() { Id = source.Id, UserId = source.UserId, Name = source.Name, Mobile = source.Mobile };
    }
