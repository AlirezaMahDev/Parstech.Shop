...
namespace Parstech.Shop.Web.Services.GrpcClients
{
    public class SettingsAdminGrpcClient : GrpcClientBase, ISettingsAdminGrpcClient
    {
        ...
        public async Task<SiteDto> GetSiteSettingsAsync(int id)
        {
            ...
            if (!response.Status)
            {
                throw new System.Exception($"Failed to get site settings: {response.Message}");
            }
        ...
        public async Task<SeoDto> GetSeoSettingsAsync(int id)
        {
            ...
            if (!response.Status)
            {
                throw new System.Exception($"Failed to get SEO settings: {response.Message}");
            }
        ...
        public async Task<SocialDto> GetSocialLinksAsync(int id)
        {
            ...
            if (!response.Status)
            {
                throw new System.Exception($"Failed to get social links: {response.Message}");
            }
        ...
        public async Task<Shop.Application.DTOs.Paging.PageingDto<SectionDto>> GetSectionsAsync(Shop.Application.DTOs.Paging.ParameterDto parameter)
        {
        ...
        public async Task<Shop.Application.DTOs.Paging.PageingDto<RepresentationTypeDto>> GetRepresentationTypesAsync(Shop.Application.DTOs.Paging.ParameterDto parameter)
        {
        ...
        public async Task<Shop.Application.DTOs.Paging.PageingDto<RepresentationDto>> GetRepresentationsAsync(RepresentationParameterDto parameter)
        {
