...
namespace Parstech.Shop.Web.Services.GrpcClients
{
    public class UserProfileGrpcClient
    {
        ...
        public async Task<UserOrdersResponse> GetUserOrdersHistoryAsync(int userId, int page, int pageSize, string searchTerm = "")
        {
        ...
        public async Task<UserTransactionsResponse> GetUserTransactionsAsync(int walletId, int page, int pageSize, string transactionType = "")
        {
