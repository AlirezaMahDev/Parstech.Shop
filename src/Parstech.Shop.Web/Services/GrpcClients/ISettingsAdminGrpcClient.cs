...
namespace Parstech.Shop.Web.Services.GrpcClients
{
    public interface ISettingsAdminGrpcClient
    {
        ...
        // Sections operations
        Task<Shop.Application.DTOs.Paging.PageingDto<SectionDto>> GetSectionsAsync(Shop.Application.DTOs.Paging.ParameterDto parameter);
        ...
        Task<Shop.Application.DTOs.Paging.PageingDto<RepresentationTypeDto>> GetRepresentationTypesAsync(Shop.Application.DTOs.Paging.ParameterDto parameter);
        ...
        Task<Shop.Application.DTOs.Paging.PageingDto<RepresentationDto>> GetRepresentationsAsync(RepresentationParameterDto parameter);
