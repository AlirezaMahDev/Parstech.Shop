...
public class ProductDetailAdminGrpcClient : GrpcClientBase
{
    ...
    public async Task<ResponseDto> UpdateStockQuantityPerBundleAsync(int stockPriceId, int quantityPerBundle)
    {
        ...
        {
            ProductStockPriceId = stockPriceId, QuantityPerBundle = quantityPerBundle
        };
    ...
    {
        var request = new PropertySearchRequest { Filter = filter ?? string.Empty, CategoryId = categoryId };
    ...
    private Shared.Protos.ProductDetailAdmin.ProductStockPriceDto MapFromProductStockPriceDto(
        ProductStockPriceDto source)
    {
        return new Shared.Protos.ProductDetailAdmin.ProductStockPriceDto
        {
            ...
            SpecialPrice = source.SpecialPrice,
            SpecialFromDate =
                source.SpecialFromDate?.ToString("yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture) ??
                string.Empty,
            SpecialToDate =
    ...
    private ProductRepresentationDto MapToProductRepresentationDto(
        Shared.Protos.ProductDetailAdmin.ProductRepresentationDto source)
    {
    ...
    private Shared.Protos.ProductDetailAdmin.ProductRepresentationDto MapFromProductRepresentationDto(
    ...
    {
        return new PropertyCateguryDto { Id = source.Id, Name = source.Name };
    }

    private PropertyDto MapToPropertyDto(Shared.Protos.ProductDetailAdmin.PropertyDto source)
    {
        return new PropertyDto { Id = source.Id, Name = source.Name, PropertyCateguryId = source.PropertyCategoryId };
    }

    private ProductTypeDto MapToProductTypeDto(Shared.Protos.ProductDetailAdmin.ProductTypeDto source)
    {
        return new ProductTypeDto { Id = source.Id, Name = source.Name };
    }

    private TaxDto MapToTaxDto(Shared.Protos.ProductDetailAdmin.TaxDto source)
    {
        return new TaxDto { Id = source.Id, Name = source.Name, Percent = source.Percent };
    }
    ...
    {
        return new UserStoreDto { Id = source.Id, UserId = source.UserId, Name = source.Name, Mobile = source.Mobile };
    }

    private RepresentationTypeDto MapToRepresentationTypeDto(
        Shared.Protos.ProductDetailAdmin.RepresentationTypeDto source)
    {
        return new RepresentationTypeDto { Id = source.Id, Name = source.Name };
    }
