...
public class RepresentationAdminGrpcClient : GrpcClientBase, IRepresentationAdminGrpcClient
{
    ...
    {
        var result = new Shop.Shared.Protos.RepresentationAdmin.RepresentationDto
        {
            Id = source.Id,
    ...
    {
        return new Shop.Shared.Protos.RepresentationAdmin.RepresentationTypeDto
        {
    ...
    {
        return new Shop.Shared.Protos.RepresentationAdmin.ProductRepresentationDto
        {
            Id = source.Id,
            ProductId = source.ProductId,
            RepresentationId = source.RepresentationId,
    ...
    {
        var result = new Shop.Shared.Protos.RepresentationAdmin.ProductStockPriceDto
        {
            Id = source.Id,
            ProductId = source.ProductId,
            StoreId = source.StoreId,
