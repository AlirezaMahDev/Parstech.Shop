...
public class ProductGrpcClient : GrpcClientBase
{
    ...
    {
        var request = new ProductPagingRequest { Parameter = parameter, UserName = userName ?? string.Empty };
    ...
    {
        var request = new ProductSearchParameter { Filter = filter, Take = take };
    ...
    public async Task<IntegratedProductsPagingResponse> GetIntegratedProductsPagingAsync(
        ProductSearchParameterRequest parameter,
        string? userName = null)
    {
        var request = new IntegratedProductsPagingRequest
        {
            Parameter = parameter, UserName = userName ?? string.Empty
        };
    ...
    {
        var request = new ProductsWithDiscountRequest { Take = take, SectionId = sectionId };
