...
public class SettingsAdminGrpcClient : GrpcClientBase, ISettingsAdminGrpcClient
{
        ...
        Shop.Application.DTOs.Paging.ParameterDto parameter)
    {
        ...
        var result = new Parstech.Shop.Application.DTOs.Paging.PageingDto<SectionDto>
        {
        ...
        Shop.Application.DTOs.Paging.ParameterDto parameter)
    {
        ...
        var result = new Parstech.Shop.Application.DTOs.Paging.PageingDto<RepresentationTypeDto>
        {
            Status = response.Status,
            Message = response.Message,
            Code = response.Code,
        ...
        RepresentationParameterDto parameter)
    {
        ...
        var result = new Parstech.Shop.Application.DTOs.Paging.PageingDto<RepresentationDto>
        {
            Status = response.Status,
            Message = response.Message,
            Code = response.Code,
