...
public partial class DatabaseContext : DbContext
{
    ...
    public virtual DbSet<CreditProductStockPrice> CreditProductStockPrices { get; set; }
...
//        => optionsBuilder.UseSqlServer("Server=4000702-56\\MSSQLSERVER22;Database=Parstech;Trusted_Connection=True;MultipleActiveResultSets=true;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CreditProductStockPrice>(entity =>
        {
            entity.ToTable("CreditProductStockPrice");

            entity.Property(e => e.Description).HasMaxLength(500);

            entity.HasOne(d => d.ProductStockPrice).WithMany(p => p.CreditProductStockPrices)
                .HasForeignKey(d => d.ProductStockPriceId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CreditProductStockPrice_ProductStockPrice");
        });
