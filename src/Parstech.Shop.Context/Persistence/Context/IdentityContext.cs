...
namespace Parstech.Shop.Context.Persistence.Context;
...
public class IdentityContext : IdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IdentityUser>(entity => { entity.ToTable(name: "IUsers"); });
        modelBuilder.Entity<IdentityRole>(entity => { entity.ToTable(name: "IRoles"); });
