...
public class GrpcMapper : Profile
{
    public GrpcMapper()
    {
        ...
        CreateMap<Product, ProductDto>()
            .ForMember(dest => dest.LatinName,
                opt => opt.MapFrom(src => src.LatinName != null ? src.LatinName : null))
            .ForMember(dest => dest.Code, opt => opt.MapFrom(src => src.Code != null ? src.Code.Value : null))
            .ForMember(dest => dest.Description,
                opt => opt.MapFrom(src => src.Description != null ? src.Description : null))
            .ForMember(dest => dest.ShortDescription,
                opt => opt.MapFrom(src => src.ShortDescription != null ? src.ShortDescription : null))
            .ForMember(dest => dest.ShortLink,
                opt => opt.MapFrom(src => src.ShortLink != null ? src.ShortLink : null))
            .ForMember(dest => dest.VariationName,
                opt => opt.MapFrom(src => src.VariationName != null ? src.VariationName : null))
            .ForMember(dest => dest.ParentId,
