...
public class GrpcMapper : Profile
{
    public GrpcMapper()
    {
        ...
        CreateMap<ProductDto, Product>()
            ...
            .ForMember(dest => dest.QuantityPerBundle,
                opt => opt.MapFrom(src =>
                    src.QuantityPerBundle.HasValue ? new Int32Value { Value = src.QuantityPerBundle.Value } : null))
            ...
            .ForMember(dest => dest.ShowInDiscountPanels,
                opt => opt.MapFrom(src =>
                    src.ShowInDiscountPanels.HasValue
                        ? new BoolValue { Value = src.ShowInDiscountPanels.Value }
                        : null))
            .ForMember(dest => dest.CateguryOfUserId,
                opt => opt.MapFrom(src =>
                    src.CateguryOfUserId.HasValue ? new Int32Value { Value = src.CateguryOfUserId.Value } : null))
            ...
            .ForMember(dest => dest.BestStockUserCateguryId,
                opt => opt.MapFrom(src =>
                    src.BestStockUserCateguryId.HasValue
                        ...
                        : null))
            .ForMember(dest => dest.DiscountDate,
                opt => opt.MapFrom(src =>
                    src.DiscountDate.HasValue
                        ? Timestamp.FromDateTime(DateTime.SpecifyKind(src.DiscountDate.Value, DateTimeKind.Utc))
                        : null))
        ...
        CreateMap<Product, ProductDto>()
            .ForMember(dest => dest.LatinName,
                opt => opt.MapFrom(src => src.LatinName != null ? src.LatinName.Value : null))
            ...
            .ForMember(dest => dest.ShortDescription,
                opt => opt.MapFrom(src => src.ShortDescription != null ? src.ShortDescription.Value : null))
            .ForMember(dest => dest.ShortLink,
                opt => opt.MapFrom(src => src.ShortLink != null ? src.ShortLink.Value : null))
            .ForMember(dest => dest.VariationName,
                opt => opt.MapFrom(src => src.VariationName != null ? src.VariationName.Value : null))
            .ForMember(dest => dest.ParentId,
                opt => opt.MapFrom(src => src.ParentId != null ? (int?)src.ParentId.Value : null))
            .ForMember(dest => dest.QuantityPerBundle,
                opt => opt.MapFrom(src => src.QuantityPerBundle != null ? (int?)src.QuantityPerBundle.Value : null))
            .ForMember(dest => dest.TaxCode, opt => opt.MapFrom(src => src.TaxCode != null ? src.TaxCode.Value : null))
            .ForMember(dest => dest.Keywords,
                opt => opt.MapFrom(src => src.Keywords != null ? src.Keywords.Value : null))
            .ForMember(dest => dest.ShowInDiscountPanels,
                opt => opt.MapFrom(src =>
                    src.ShowInDiscountPanels != null ? (bool?)src.ShowInDiscountPanels.Value : null))
            .ForMember(dest => dest.CateguryOfUserId,
                opt => opt.MapFrom(src => src.CateguryOfUserId != null ? (int?)src.CateguryOfUserId.Value : null))
            .ForMember(dest => dest.BestStockId,
            ...
            .ForMember(dest => dest.DiscountDate,
                opt => opt.MapFrom(src => src.DiscountDate != null ? src.DiscountDate.ToDateTime() : (DateTime?)null))
        ...
        CreateMap<Order, OrderDto>()
            .ForMember(dest => dest.CreateDate, opt => opt.MapFrom(src => src.CreateDate.ToDateTime()))
            .ForMember(dest => dest.IntroCode,
                opt => opt.MapFrom(src => src.IntroCode != null ? src.IntroCode.Value : null))
            .ForMember(dest => dest.ConfirmPayment,
                opt => opt.MapFrom(src => src.ConfirmPayment != null ? (bool?)src.ConfirmPayment.Value : null))
            .ForMember(dest => dest.FactorFile,
                opt => opt.MapFrom(src => src.FactorFile != null ? src.FactorFile.Value : null));
        ...
        CreateMap<UserShipping, UserShippingDto>()
            ...
            .ForMember(dest => dest.PostCode,
                opt => opt.MapFrom(src => src.PostCode != null ? src.PostCode.Value : null));
