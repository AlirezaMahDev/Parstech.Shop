...
public static class OrderShippingMapperExtensions
{
    public static void AddOrderShippingMappings(this IMapperConfigurationExpression cfg)
    {
        ...
        cfg.CreateMap<OrderShipping, OrderShippingDto>()
            ...
            .ForMember(dest => dest.FullAddress,
                opt => opt.MapFrom(src => src.FullAddress != null ? src.FullAddress.Value : null));
        ...
        cfg.CreateMap<Shop.Shared.Protos.OrderShipping.UserShipping,
                Shop.Application.DTOs.UserShipping.UserShippingDto>()
            .ForMember(dest => dest.FirstName,
                opt => opt.MapFrom(src => src.FirstName != null ? src.FirstName.Value : null))
            .ForMember(dest => dest.LastName,
                opt => opt.MapFrom(src => src.LastName != null ? src.LastName.Value : null))
        ...
        cfg.CreateMap<Shop.Application.DTOs.UserShipping.UserShippingDto,
                Shop.Shared.Protos.OrderShipping.UserShipping>()
            .ForMember(dest => dest.FirstName,
                opt => opt.MapFrom(src => src.FirstName != null ? new StringValue { Value = src.FirstName } : null))
            .ForMember(dest => dest.LastName,
                opt => opt.MapFrom(src => src.LastName != null ? new StringValue { Value = src.LastName } : null))
