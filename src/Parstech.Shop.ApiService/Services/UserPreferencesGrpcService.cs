...
using Parstech.Shop.Shared.Protos.UserPreferencesService;
...
namespace Shop.ApiService.Services
{
    public class UserPreferencesGrpcService : UserPreferencesService.UserPreferencesServiceBase
    {
        ...
        public override async Task<UserBillingResponse> UpdateUserBilling(UpdateBillingRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<StatusResponse> ChangePassword(ChangePasswordRequest request, ServerCallContext context)
        {
            try
            {
                var userNameClaim = context.GetHttpContext().User.Identity?.Name;
        ...
        public override async Task<FavoriteProductsResponse> GetFavoriteProducts(UserNameRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ComparisonProductsResponse> GetComparisonProducts(UserNameRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<WalletAmountResponse> GetWalletAmount(UserIdRequest request, ServerCallContext context)
        {
            try
            {
                ...
                return new WalletAmountResponse
                {
        ...
        public override async Task<WalletFacilitiesResponse> GetWalletFacilities(UserIdRequest request, ServerCallContext context)
        {
            try
            {
                var wallet = await _mediator.Send(new GetWalletByUserIdQueryReq(request.UserId));
                
                return new WalletFacilitiesResponse
                {
                    Facilities = wallet.Fecilities
                };
            }
            catch (Exception ex)
            {
