...
public class ReportsAdminGrpcService : ReportsAdminService.ReportsAdminServiceBase
{
    ...
    public override async Task<UsersForSelectListResponse> GetUsersForSelectList(EmptyRequest request,
        ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, $"Error getting users: {ex.Message}"));
        }
    }

    public override async Task<WalletTransactionPagingDto> GetTransactionsReport(TransactionParameterDto request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, $"Error getting transactions report: {ex.Message}"));
        }
    }

    public override async Task<WalletTransactionPagingDto> GetActiveCreditReport(TransactionParameterDto request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, $"Error getting active credit report: {ex.Message}"));
        }
    }

    public override async Task<WalletTransactionPagingDto> GetActiveInstallments(UserIdRequest request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, $"Error getting active installments: {ex.Message}"));
        }
    }

    public override async Task<ExcelResponse> GenerateTransactionsExcel(TransactionReportExcelRequest request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            return new ExcelResponse
            {
                IsSuccess = false, Message = $"Error generating transactions excel: {ex.Message}"
            };
        }
    }

    public override async Task<ExcelResponse> GenerateActiveCreditExcel(TransactionReportExcelRequest request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            return new ExcelResponse
            {
                IsSuccess = false, Message = $"Error generating active credit excel: {ex.Message}"
            };
        }
    }
        ...
        Shop.Application.DTOs.WalletTransaction.WalletTransactionPagingDto result)
    {
        WalletTransactionPagingDto response = new()
        {
            ...
            Parameter = result.Parameter != null
