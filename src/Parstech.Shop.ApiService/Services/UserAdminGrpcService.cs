...
public class UserAdminGrpcService : UserAdminService.UserAdminServiceBase
{
    ...
    public override async Task<LoginResponse> LoginByUser(UserIdRequest request, ServerCallContext context)
    {
        ...
        {
            Status = result.Status, Message = result.Message, Code = result.Code, Token = result.Data
        };
    }
    ...
    public override async Task<ResponseDto> CreateUserBilling(CreateUserBillingRequest request,
        ServerCallContext context)
    {
    ...
    public override async Task<ResponseDto> UpdateUserBilling(UpdateUserBillingRequest request,
        ServerCallContext context)
    {
    ...
    public override async Task<ResponseDto> CreateUserShipping(CreateUserShippingRequest request,
        ServerCallContext context)
    {
    ...
    public override async Task<ResponseDto> UpdateUserShipping(UpdateUserShippingRequest request,
        ServerCallContext context)
    {
    ...
    public override async Task<UserRoleListResponse> GetUserRoles(UserIdRequest request, ServerCallContext context)
    {
        ...
        foreach (var role in result.Data)
        {
            ...
            {
                RoleId = role.RoleId, RoleName = role.RoleName, IsSelected = role.IsSelected
            });
        }
