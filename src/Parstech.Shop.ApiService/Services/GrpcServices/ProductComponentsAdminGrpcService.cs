...
public class ProductComponentsAdminGrpcService : ProductComponentsAdminService.ProductComponentsAdminServiceBase
{
        ...
        ServerCallContext context)
    {
        try
        {
            ...
            {
                void product = await _mediator.Send(new ProductReadCommandReq(request.Gallery.ProductId));
                product.IsActive = false;
                await _mediator.Send(new ProductUpdateCommandReq(product));
            }

            return new ResponseDto { IsSuccessed = result.IsSuccessed, Message = result.Message ?? string.Empty };
        }
        catch (Exception ex)
        {
            throw new RpcException(new(StatusCode.Internal, $"An error occurred: {ex.Message}"));
    ...
    public override async Task<ResponseDto> DeleteProductGallery(GalleryIdRequest request, ServerCallContext context)
    {
        try
        {
            ...
            return new ResponseDto { IsSuccessed = true, Message = "تصویر محصول با موفقیت حذف گردید." };
        }
        catch (Exception ex)
        {
            throw new RpcException(new(StatusCode.Internal, $"An error occurred: {ex.Message}"));
        ...
        ServerCallContext context)
    {
        try
        {
            void result = await _mediator.Send(new ChangeMainGalleryCommandReq(request.GalleryId, request.ProductId));
        ...
        ServerCallContext context)
    {
        try
        {
            void categories = await _mediator.Send(new CateguriesOfProductQueryReq(request.ProductId));
        ...
        ServerCallContext context)
    {
        try
        {
            void category = await _mediator.Send(new CateguryOfProductQueryReq(request.ProductId));
        ...
        ServerCallContext context)
    {
        try
        {
            void productId = await _mediator.Send(new ProductCateguryDeleteCommandReq(request.ProductId));
