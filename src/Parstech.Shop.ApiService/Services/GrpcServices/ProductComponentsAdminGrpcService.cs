...
namespace Parstech.Shop.ApiService.Services.GrpcServices
{
    public class ProductComponentsAdminGrpcService : ProductComponentsAdminService.ProductComponentsAdminServiceBase
    {
        ...
        public override async Task<ProductGalleryListResponse> GetGalleriesOfProduct(ProductIdRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ResponseDto> CreateProductGallery(ProductGalleryRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ResponseDto> DeleteProductGallery(GalleryIdRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "تصویر محصول با موفقیت حذف گردید."
                };
            }
            catch (System.Exception ex)
            {
        ...
        public override async Task<ResponseDto> ChangeMainGallery(ChangeMainGalleryRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ProductCategoryListResponse> GetCategoriesOfProduct(ProductIdRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ProductCategoryResponse> GetCategoryOfProduct(ProductIdRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ProductIdResponse> DeleteProductCategory(ProductIdRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ChildsAndStocksResponse> GetChildsAndProductStocks(ChildsAndStocksRequest request, ServerCallContext context)
        {
            try
            {
                var result = await _mediator.Send(new GetChildsAndProductStocksQueryReq(request.ProductId, request.StoreId));
                
                var response = new ChildsAndStocksResponse
                {
                    IsSuccess = true
                };
        ...
        public override async Task<ProductPropertyListResponse> GetPropertiesOfProduct(ProductIdRequest request, ServerCallContext context)
        {
            try
            {
                var properties = await _mediator.Send(new PropertiesOfProductQueryReq(request.ProductId));
                
                var response = new ProductPropertyListResponse
                {
                    IsSuccess = true
                };
        ...
        public override async Task<ProductDetailResponse> GetProductDetail(ProductDetailRequest request, ServerCallContext context)
        {
            try
            {
                var productDetail = await _mediator.Send(new ProductDetailShowQueryReq(request.ShortLink, request.StoreId, request.UserName));
                
                var response = new ProductDetailResponse
                {
                    IsSuccess = true,
                    Product = MapProductDto(productDetail.Product)
                };
