...
namespace Parstech.Shop.ApiService.Services
{
    public class SectionAdminGrpcService : SectionAdminService.SectionAdminServiceBase
    {
        ...
        /// </summary>
        public override async Task<SectionAndDetailsListResponse> GetSectionsAndDetails(SectionRequest request, ServerCallContext context)
        {
            try
            {
                var result = await _mediator.Send(new SectionAndDetailsReadsQueryReq(request.StoreId > 0 ? request.StoreId : null));
            ...
            catch (Exception ex)
            {
                ...
                throw new RpcException(new Status(StatusCode.Internal, "An error occurred while retrieving sections and details"));
            }
        }
        ...
        public override async Task<SectionDto> GetSectionById(SectionIdRequest request, ServerCallContext context)
        {
            try
            {
                ...
                if (section == null)
                {
                    throw new RpcException(new Status(StatusCode.NotFound, $"Section with ID {request.SectionId} not found"));
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new RpcException(new Status(StatusCode.Internal, "An error occurred while retrieving the section"));
            }
        }
        ...
        /// </summary>
        public override async Task<SectionDetailDto> GetSectionDetailById(SectionDetailIdRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    throw new RpcException(new Status(StatusCode.NotFound, $"Section detail with ID {request.SectionDetailId} not found"));
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new RpcException(new Status(StatusCode.Internal, "An error occurred while retrieving the section detail"));
            }
        }
        ...
        public override async Task<ResponseDto> CreateSection(SectionDto request, ServerCallContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = "خطا در ایجاد قسمت جدید"
                };
            }
        }
        ...
        public override async Task<ResponseDto> CreateSectionDetail(SectionDetailDto request, ServerCallContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = "خطا در ایجاد جزئیات قسمت"
                };
            }
        }
        ...
        public override async Task<ResponseDto> UpdateSectionDetail(SectionDetailDto request, ServerCallContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = "خطا در بروزرسانی جزئیات قسمت"
                };
            }
        }
        ...
        /// </summary>
        public override async Task<ResponseDto> DeleteSectionDetail(SectionDetailIdRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = "خطا در حذف جزئیات قسمت"
                };
            }
        }
        ...
        /// </summary>
        public override async Task<BoolResponse> CheckSectionCanBeDeleted(SectionIdRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                throw new RpcException(new Status(StatusCode.Internal, "An error occurred while checking if section can be deleted"));
            }
        }
