...
namespace Parstech.Shop.ApiService.Services
{
    public class ConfigAdminGrpcService : ConfigAdminService.ConfigAdminServiceBase
    {
        ...
        public override async Task<CreditInfoResponse> GetCreditOfNationalCode(NationalCodeRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Error retrieving credit information: " + ex.Message
                };
            }
        }
        ...
        public override async Task<ResponseDto> AddProductsByExcel(ExcelFileRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "Products added successfully from Excel file",
                    Code = 200
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error adding products from Excel: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<ApiDataResponse> GetApiData(ApiDataRequest request, ServerCallContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Error retrieving API data: " + ex.Message
                };
            }
        }

        public override async Task<WordpressProductsResponse> GetProductsFromWordpress(WordpressPageRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Success = true,
                    Message = "WordPress products retrieved successfully"
                };
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Error retrieving WordPress products: " + ex.Message
                };
            }
        }

        public override async Task<WordpressProductResponse> GetProductFromWordpressById(WordpressProductIdRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Error retrieving WordPress product: " + ex.Message
                };
            }
        }

        public override async Task<WordpressCategoriesResponse> GetCateguriesFromWordpress(WordpressPageRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Success = true,
                    Message = "WordPress categories retrieved successfully"
                };
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Error retrieving WordPress categories: " + ex.Message
                };
            }
        }
        ...
        public override async Task<ResponseDto> FixProductStocks(EmptyRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "Product stocks fixed successfully",
                    Code = 200
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error fixing product stocks: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<ResponseDto> FixDublicate(EmptyRequest request, ServerCallContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error fixing duplicates: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<ResponseDto> DatetimeChange(EmptyRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "Datetime changed successfully",
                    Code = 200
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error changing datetime: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<ResponseDto> SetBestStockId(EmptyRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "Best stock ID set successfully",
                    Code = 200
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error setting best stock ID: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<ResponseDto> ExcelFixProducts(ExcelFileRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "Products fixed successfully from Excel file",
                    Code = 200
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error fixing products from Excel: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> EditCateguriesOfProducts(ExcelFileRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "Product categories edited successfully from Excel file",
                    Code = 200
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error editing product categories from Excel: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<ResponseDto> AddUsersAndWalletCredit(ExcelFileRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "Users and wallet credit added successfully from Excel file",
                    Code = 200
                };
            }
            catch (Exception ex)
        ...
        public override async Task<ResponseDto> UpdateUserWalletsCredit(ExcelFileRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "User wallets credit updated successfully from Excel file",
                    Code = 200
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error updating user wallets credit from Excel: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<ResponseDto> FillProductCode(ExcelFileRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    Status = true,
                    Message = "Product codes filled successfully from Excel file",
                    Code = 200
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error filling product codes from Excel: " + ex.Message,
                    Code = 500
                };
            }
        }
