...
using Parstech.Shop.Shared.Protos.SettingsAdmin;
using Shop.Application.DTOs.Represantation;
...
using Shop.Application.Features.SeoSeting.Requests.Commands;
using Shop.Application.Features.SiteSeting.Requests.Commands;
using Shop.Application.Features.SocialSeting.Requests.Commands;
using System;
using System.Linq;
...
namespace Parstech.Shop.ApiService.Services
{
    public class SettingsAdminGrpcService : SettingsAdminService.SettingsAdminServiceBase
    {
        ...
        public override async Task<SiteSettingsResponse> GetSiteSettings(SiteSettingsRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error retrieving site settings: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> UpdateSiteSettings(UpdateSiteSettingsRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error updating site settings: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<SeoSettingsResponse> GetSeoSettings(SeoSettingsRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error retrieving SEO settings: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> UpdateSeoSettings(UpdateSeoSettingsRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error updating SEO settings: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<SocialLinksResponse> GetSocialLinks(SocialLinksRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error retrieving social links: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> UpdateSocialLinks(UpdateSocialLinksRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error updating social links: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<SectionsResponse> GetSections(SectionsRequest request, ServerCallContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error retrieving sections: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<RepresentationTypesResponse> GetRepresentationTypes(RepresentationTypesRequest request, ServerCallContext context)
        {
            try
            {
                var parameter = new Shop.Application.DTOs.Paging.ParameterDto
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error retrieving representation types: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> CreateRepresentationType(CreateRepresentationTypeRequest request, ServerCallContext context)
        {
            try
            {
                var typeDto = new RepresentationTypeDto
                {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error creating representation type: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> UpdateRepresentationType(UpdateRepresentationTypeRequest request, ServerCallContext context)
        {
            try
            {
                var typeDto = new RepresentationTypeDto
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error updating representation type: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> DeleteRepresentationType(DeleteRepresentationTypeRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error deleting representation type: " + ex.Message,
                    Code = 500
                };
            }
        }
        ...
        public override async Task<RepresentationsResponse> GetRepresentations(RepresentationsRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error retrieving representations: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> CreateRepresentation(CreateRepresentationRequest request, ServerCallContext context)
        {
            try
            {
                var representationDto = new RepresentationDto
                {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error creating representation: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> UpdateRepresentation(UpdateRepresentationRequest request, ServerCallContext context)
        {
            try
            {
                var representationDto = new RepresentationDto
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error updating representation: " + ex.Message,
                    Code = 500
                };
            }
        }

        public override async Task<ResponseDto> DeleteRepresentation(DeleteRepresentationRequest request, ServerCallContext context)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Status = false,
                    Message = "Error deleting representation: " + ex.Message,
                    Code = 500
                };
            }
        }
