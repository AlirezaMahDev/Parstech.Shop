...
namespace Shop.ApiService.Services
{
    public class CategoryAdminGrpcService : CategoryAdminService.CategoryAdminServiceBase
    {
        ...
        public override async Task<CategoryPageingDto> GetCategoriesForAdmin(CategoryParameterRequest request, ServerCallContext context)
        {
        ...
        public override async Task<CategoryListResponse> GetAllCategories(CategoryFilterRequest request, ServerCallContext context)
        {
