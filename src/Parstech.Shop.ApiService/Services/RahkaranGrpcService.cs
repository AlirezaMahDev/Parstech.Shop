...
namespace Shop.ApiService.Services
{
    public class RahkaranGrpcService : RahkaranService.RahkaranServiceBase
    {
        ...
        public override async Task<RahkaranAllResponse> GetAllRahkaranData(GetRahkaranDataRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RahkaranOrderResponse> GetRahkaranOrder(GetRahkaranOrderRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RahkaranOrderResponse> CreateRahkaranOrder(CreateRahkaranOrderRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RahkaranOrderResponse> UpdateRahkaranOrder(UpdateRahkaranOrderRequest request, ServerCallContext context)
        {
            try
            {
                var orderDto = new RahkaranOrderDto
        ...
        // User operations
        public override async Task<RahkaranUserResponse> GetRahkaranUser(GetRahkaranUserRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RahkaranUserResponse> CreateRahkaranUser(CreateRahkaranUserRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RahkaranUserResponse> UpdateRahkaranUser(UpdateRahkaranUserRequest request, ServerCallContext context)
        {
            try
            {
                var userDto = new RahkaranUserDto
        ...
        // Product operations
        public override async Task<RahkaranProductResponse> GetRahkaranProduct(GetRahkaranProductRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RahkaranProductResponse> CreateRahkaranProduct(CreateRahkaranProductRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RahkaranProductResponse> UpdateRahkaranProduct(UpdateRahkaranProductRequest request, ServerCallContext context)
        {
            try
            {
                var productDto = new RahkaranProductDto
        ...
        public override async Task<ApiResponse> FollowOrderFromApi(FollowOrderFromApiRequest request, ServerCallContext context)
        {
            try
            {
