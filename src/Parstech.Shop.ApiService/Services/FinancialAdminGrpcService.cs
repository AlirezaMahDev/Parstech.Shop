...
public class FinancialAdminGrpcService : FinancialAdminService.FinancialAdminServiceBase
{
    ...
    public override async Task<PagingDto> GetWalletsPaging(ParameterDto request, ServerCallContext context)
    {
        try
        {
            ...
            ByteString? filterBytes = ByteString.CopyFrom(JsonConvert.SerializeObject(pagingResult.Filter),
                System.Text.Encoding.UTF8);
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, $"Error getting wallets: {ex.Message}"));
        }
    }
    ...
    public override async Task<UserFiltersResponse> GetUserFilters(EmptyRequest request, ServerCallContext context)
    {
        try
        {
            ...
            foreach (var filter in filters)
            {
                ...
                {
                    Id = filter.Id, Name = filter.Name, UserName = filter.UserName, NameValue = filter.NameValue
                });
            }
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, $"Error getting user filters: {ex.Message}"));
        }
    }
    ...
    public override async Task<ResponseDto> BlockOrUnblockWallet(BlockWalletRequest request, ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new() { Status = false, Message = $"Error blocking/unblocking wallet: {ex.Message}", Code = 500 };
        }
    }
    ...
    public override async Task<PagingDto> GetWalletTransactionsPaging(WalletTransactionParameterDto request,
        ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, $"Error getting wallet transactions: {ex.Message}"));
        }
    }

    public override async Task<ResponseDto> CreateWalletTransaction(WalletTransactionDto request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            return new() { Status = false, Message = $"Error creating wallet transaction: {ex.Message}", Code = 500 };
        }
    }

    public override async Task<WalletTransactionDto> GetWalletTransactionDetail(TransactionIdRequest request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, $"Error getting wallet transaction detail: {ex.Message}"));
        }
    }
    ...
    public override async Task<ResponseDto> PayInstallment(TransactionIdRequest request, ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new() { Status = false, Message = $"Error paying installment: {ex.Message}", Code = 500 };
        }
    }
    ...
    public override async Task<ResponseDto> CreateFacilities(FacilitiesDto request, ServerCallContext context)
    {
        try
        {
            ...
            return new() { Status = false, Message = "Facilities creation is not currently implemented", Code = 501 };
        ...
        catch (Exception ex)
        {
            ...
            return new() { Status = false, Message = $"Error creating facilities: {ex.Message}", Code = 500 };
        }
    }

    public override async Task<ResponseDto> RegisterFacilitiesByExcel(ExcelUploadRequest request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            return new()
            {
                Status = false, Message = $"Error registering facilities by Excel: {ex.Message}", Code = 500
            };
        }
    }

    public override async Task<ResponseDto> ProcessFacilityPaymentsByExcel(ExcelUploadRequest request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            return new()
            {
                Status = false, Message = $"Error processing facility payments by Excel: {ex.Message}", Code = 500
            };
        }
    }
