...
namespace Shop.ApiService.Services
{
    public class SectionGrpcService : SectionService.SectionServiceBase
    {
        ...
        public override async Task<SectionWithDetailsResponse> GetSectionAndDetailsById(SectionByIdRequest request, ServerCallContext context)
        {
            try
            {
                ...
                if (section.SectionTypeId == 2 && section.CateguryId != 0 && string.IsNullOrEmpty(section.latinCateguryName))
                {
        ...
        public override async Task<SectionWithDetailsResponse> GetSectionAndDetailsByStore(SectionByStoreRequest request, ServerCallContext context)
        {
            try
            {
