...
public class WalletGrpcService : Shared.Protos.Wallet.WalletService.WalletServiceBase
{
    ...
    public override async Task<Shared.Protos.Wallet.WalletResponse> GetWalletByUserId(
        Shared.Protos.Wallet.WalletRequest request, 
        ServerCallContext context)
    {
        try
        {
            ...
            return new Shared.Protos.Wallet.WalletResponse
            {
                ...
                Status = new Shared.Protos.Common.ResponseDto
                {
                    Success = true,
    ...
    public override async Task<Shared.Protos.Wallet.CalculateResponse> CalculateInstallments(
        Shared.Protos.Wallet.CalculateRequest request,
        ServerCallContext context)
    {
        try
        {
            ...
            return new Shared.Protos.Wallet.CalculateResponse
            {
