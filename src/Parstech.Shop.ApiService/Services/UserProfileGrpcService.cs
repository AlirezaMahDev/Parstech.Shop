...
public class UserProfileGrpcService : UserProfileService.UserProfileServiceBase
{
    ...
    public override async Task<UserShippingListResponse> GetUserShippingAddresses(UserShippingRequest request,
    ...
    public override async Task<UserShippingResponse> GetUserShippingById(ShippingIdRequest request,
        ServerCallContext context)
    {
        try
        {
    ...
    public override async Task<UserShippingResponse> CreateUserShipping(CreateShippingRequest request,
        ServerCallContext context)
    {
        try
        {
    ...
    public override async Task<UserShippingResponse> UpdateUserShipping(UpdateShippingRequest request,
        ServerCallContext context)
    {
        try
        {
    ...
    public override async Task<DeleteShippingResponse> DeleteUserShipping(ShippingIdRequest request,
        ServerCallContext context)
    {
        try
        {
            ...
            return new DeleteShippingResponse { Success = true, Message = "آدرس شما با موفقیت حذف گردید" };
        }
        catch (Exception ex)
        {
            return new DeleteShippingResponse { Success = false, Message = $"خطا در حذف آدرس: {ex.Message}" };
        }
    }

    public override async Task<UserOrdersResponse> GetUserOrdersHistory(UserOrdersRequest request,
        ServerCallContext context)
    {
        try
        {
            ...
            {
                TotalCount = result.RowCount, PageCount = result.PageCount, CurrentPage = result.CurrentPage
            };
    ...
    public override async Task<UserTransactionsResponse> GetUserTransactions(UserTransactionsRequest request,
        ServerCallContext context)
    {
        try
        {
    ...
    public override async Task<TransactionDetailsResponse> GetTransactionDetails(TransactionDetailsRequest request,
        ServerCallContext context)
    {
        try
        {
