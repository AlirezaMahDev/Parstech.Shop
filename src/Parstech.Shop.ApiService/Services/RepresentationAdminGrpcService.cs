...
using Parstech.Shop.Shared.Protos.RepresentationAdmin;
...
using Shop.Application.Features.Representation.Requests.Queries;
using Shop.Application.Features.RepresentationType.Requests.Commands;
using Shop.Application.Features.RepresentationType.Requests.Queries;
...
namespace Parstech.Shop.ApiService.Services
{
    public class RepresentationAdminGrpcService : RepresentationAdminService.RepresentationAdminServiceBase
    {
        ...
        public override async Task<RepresentationDto> GetRepresentationById(RepresentationRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RepresentationPagingDto> GetRepresentations(RepresentationParameterRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ResponseDto> CreateRepresentation(RepresentationDto request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "نمایش با موفقیت ثبت شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در ثبت نمایش: {ex.Message}"
                };
            }
        }
        ...
        public override async Task<ResponseDto> UpdateRepresentation(RepresentationDto request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "نمایش با موفقیت بروزرسانی شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در بروزرسانی نمایش: {ex.Message}"
                };
            }
        }

        public override async Task<ResponseDto> DeleteRepresentation(RepresentationRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "نمایش با موفقیت حذف شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در حذف نمایش: {ex.Message}"
                };
            }
        }
        ...
        public override async Task<RepresentationTypeListResponse> GetRepresentationTypes(EmptyRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<RepresentationTypeDto> GetRepresentationTypeById(RepresentationTypeRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ResponseDto> CreateRepresentationType(RepresentationTypeDto request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "نوع نمایش با موفقیت ثبت شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در ثبت نوع نمایش: {ex.Message}"
                };
            }
        }

        public override async Task<ResponseDto> UpdateRepresentationType(RepresentationTypeDto request, ServerCallContext context)
        {
            try
            {
                var type = MapFromRepresentationTypeDto(request);
                ...
                {
                    IsSuccessed = true,
                    Message = "نوع نمایش با موفقیت بروزرسانی شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در بروزرسانی نوع نمایش: {ex.Message}"
                };
            }
        }

        public override async Task<ResponseDto> DeleteRepresentationType(RepresentationTypeRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "نوع نمایش با موفقیت حذف شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در حذف نوع نمایش: {ex.Message}"
                };
            }
        }
        ...
        public override async Task<ProductRepresentationListResponse> GetProductRepresentations(ProductRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ResponseDto> AddProductRepresentation(ProductRepresentationDto request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "نمایش محصول با موفقیت ثبت شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در ثبت نمایش محصول: {ex.Message}"
                };
            }
        }

        public override async Task<ResponseDto> QuickAddProductRepresentation(ProductRepresentationDto request, ServerCallContext context)
        {
            try
            {
                var representation = MapFromProductRepresentationDto(request);
            ...
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در ثبت سریع نمایش محصول: {ex.Message}"
                };
            }
        }

        public override async Task<ResponseDto> DeleteProductRepresentation(ProductRepresentationRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "نمایش محصول با موفقیت حذف شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در حذف نمایش محصول: {ex.Message}"
                };
            }
        }
        ...
        public override async Task<ProductStockPriceDto> GetProductStockPrice(ProductStockPriceRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ResponseDto> UpdateProductStockPrice(ProductStockPriceDto request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    IsSuccessed = true,
                    Message = "قیمت محصول با موفقیت بروزرسانی شد"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccessed = false,
                    Message = $"خطا در بروزرسانی قیمت محصول: {ex.Message}"
                };
            }
        }
        ...
        public override async Task<ProductLogPagingDto> GetProductLogs(ProductLogParameterRequest request, ServerCallContext context)
        {
            try
            {
        ...
        private Shop.Application.DTOs.RepresentationType.RepresentationTypeDto MapFromRepresentationTypeDto(RepresentationTypeDto source)
        {
