...
public class StoreAdminGrpcService : StoreAdminService.StoreAdminServiceBase
{
    ...
    /// </summary>
    public override async Task<SalesPagingDto> GetSalesForStore(SalesParameterRequest request,
        ServerCallContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, "An error occurred while retrieving sales data"));
        }
    }
    ...
    /// </summary>
    public override async Task<OrderStatusesResponse> GetOrderStatuses(OrderStatusRequest request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, "An error occurred while retrieving order statuses"));
        }
    }
    ...
    /// </summary>
    public override async Task<ContractResponse> GetContractForOrder(ContractOrderRequest request,
        ServerCallContext context)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            throw new RpcException(new(StatusCode.Internal, "An error occurred while retrieving the contract"));
        }
    }
    ...
    private SalesDto MapToSalesDto(Shop.Application.DTOs.OrderDetail.SalesDto source)
    {
        ...
        {
            result.CreateDate =
                Google.Protobuf.WellKnownTypes.Timestamp.FromDateTime(source.CreateDate.Value.ToUniversalTime());
        }
