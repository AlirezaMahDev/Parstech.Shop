using Grpc.Core;
using MediatR;
using Parstech.Shop.Shared.Protos.ShippingService;
...
namespace Shop.ApiService.Services
{
    public class ShippingGrpcService : ShippingService.ShippingServiceBase
    {
        ...
        public override async Task<UserShippingResponse> GetFirstUserShipping(FirstShippingRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<ChangeShippingResponse> ChangeOrderShipping(ChangeShippingRequest request, ServerCallContext context)
        {
            try
            {
        ...
        public override async Task<OrderShippingResponse> GetOrderShipping(OrderShippingRequest request, ServerCallContext context)
        {
            try
            {
