...
public class RefreshOrderDetailQueryHandler : IRequestHandler<RefreshOrderDetailQueryReq, OrderResponse>
{
    ...
    public RefreshOrderDetailQueryHandler(IMediator mediator,
        IMapper mapper,
    ...
    public async Task<OrderResponse> Handle(RefreshOrderDetailQueryReq request, CancellationToken cancellationToken)
    {
        ...
        switch (product.TaxId)
        {
            ...
            case 1:
                long withoutTax = PersentCalculator.BaseCalculatorByPrice(Price);
                ...
                OrderDetailDto? FinalDetail = _mapper.Map<OrderDetailDto>(Detail);
            ...
            case 2:
                ...
                OrderDetailDto? FinalDetail2 = _mapper.Map<OrderDetailDto>(Detail);
