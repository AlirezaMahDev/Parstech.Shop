...
public class
    GetCateguryFromWordpressQueryHandler : IRequestHandler<GetCateguryFromWordpressQueryReq, List<resultWordpress>>
{
    ...
    public async Task<List<resultWordpress>> Handle(GetCateguryFromWordpressQueryReq request,
