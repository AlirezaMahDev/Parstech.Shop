...
public class
    ReportOfWalletTransactionsQueryHandler : IRequestHandler<ReportOfWalletTransactionsQueryReq,
    WalletTransactionPagingDto>
{
    ...
    public async Task<WalletTransactionPagingDto> Handle(ReportOfWalletTransactionsQueryReq request,
        CancellationToken cancellationToken)
    {
        ...
        List<WalletTransactionReportDto> list = DapperHelper.ExecuteCommand(_connectionString,
            conn => conn.Query<WalletTransactionReportDto>(_transactionQuery.GetAllTransaction).ToList());
