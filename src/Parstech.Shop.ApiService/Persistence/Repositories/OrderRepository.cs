...
public class OrderRepository : GenericRepository<Order>, IOrderRepository
{
    ...
    public OrderRepository(DatabaseContext context, IMapper mapper, IOrderStatusRepository orderStatusRepo) :
        base(context)
    {
        _context = context;
        _mapper = mapper;
            ...
            if (order.OrderDetailDto.Count() > 0)
            {
                ...
                if (table != null)
                {
                    ...
                    for (int i = 0; i < order.OrderDetailDto.Count; i++)
                    {
                        ...
                        long cell9 = order.OrderDetailDto[i].Total * 10;
                        ...
                        newRow.Cells[0]
                            .Paragraphs.First()
                            .ReplaceText("*", row.ToString(), false, RegexOptions.IgnoreCase);
                        newRow.Cells[0].Paragraphs.First().Alignment = Alignment.right;
                        newRow.Cells[1]
                            .Paragraphs.First()
                            .ReplaceText("کد کالا",
                                order.OrderDetailDto[i].ProductCode,
                                false,
                                RegexOptions.IgnoreCase);
                        newRow.Cells[2]
                            .Paragraphs.First()
                            .ReplaceText("شرح کالا یا خدمات",
                                order.OrderDetailDto[i].ProductName,
                                false,
                                RegexOptions.IgnoreCase);
                        ...
                        newRow.Cells[3]
                            .Paragraphs.First()
                            .ReplaceText("تعداد",
                                order.OrderDetailDto[i].Count.ToString(),
                                false,
                                RegexOptions.IgnoreCase);
                        newRow.Cells[4].Paragraphs.First().ReplaceText("واحد", "عدد", false, RegexOptions.IgnoreCase);
                        newRow.Cells[5]
                            .Paragraphs.First()
                            .ReplaceText("مبلغ واحد ریال", cell5.ToString("#,0"), false, RegexOptions.IgnoreCase);
                        newRow.Cells[6]
                            .Paragraphs.First()
                            .ReplaceText("مبلغ کل ریال", cell6.ToString("#,0"), false, RegexOptions.IgnoreCase);

                        newRow.Cells[7]
                            .Paragraphs.First()
                            .ReplaceText("مبلغ تخفیف ریال", cell7.ToString("#,0"), false, RegexOptions.IgnoreCase);
                        ...
                        newRow.Cells[8]
                            .Paragraphs.First()
                            .ReplaceText("مالیات و عوارض ریال", cell8.ToString("#,0"), false, RegexOptions.IgnoreCase);
                        newRow.Cells[9]
                            .Paragraphs.First()
                            .ReplaceText("جمع مبلغ کل مالیات و عوارض ریال",
                                cell9.ToString("#,0"),
                                false,
                                RegexOptions.IgnoreCase);
                    }
                    ...
                    long totalCell6 = order.Order.OrderSum * 10;
                    long totalCell7 = order.Order.Discount * 10;
                    long totalCell8 = order.Order.Tax * 10;
                    long totalCell9 = order.Order.Total * 10;
                    ...
                    lastRow.Cells[2]
                        .Paragraphs.First()
                        .ReplaceText("شرح کالا یا خدمات", "جمع کل", false, RegexOptions.IgnoreCase);
                    ...
                    lastRow.Cells[5]
                        .Paragraphs.First()
                        .ReplaceText("مبلغ واحد ریال", "", false, RegexOptions.IgnoreCase);
                    lastRow.Cells[6]
                        .Paragraphs.First()
                        .ReplaceText("مبلغ کل ریال", totalCell6.ToString("#,0"), false, RegexOptions.IgnoreCase);

                    lastRow.Cells[7]
                        .Paragraphs.First()
                        .ReplaceText("مبلغ تخفیف ریال", totalCell7.ToString("#,0"), false, RegexOptions.IgnoreCase);
                    ...
                    lastRow.Cells[8]
                        .Paragraphs.First()
                        .ReplaceText("مالیات و عوارض ریال", totalCell8.ToString("#,0"), false, RegexOptions.IgnoreCase);
                    lastRow.Cells[9]
                        .Paragraphs.First()
                        .ReplaceText("جمع مبلغ کل مالیات و عوارض ریال",
                            totalCell9.ToString("#,0"),
                            false,
                            RegexOptions.IgnoreCase);
                    ...
                    if (order.OrderPay.Count() > 0)
                    {
                        ...
                        payRow.Cells[2]
                            .Paragraphs.First()
                            .ReplaceText("شرح کالا یا خدمات", "نحوه پرداخت", false, RegexOptions.IgnoreCase);
                        ...
                        payRow.Cells[4]
                            .Paragraphs.First()
                            .ReplaceText("واحد", "مبلغ پرداختی", false, RegexOptions.IgnoreCase);
                        payRow.Cells[5]
                            .Paragraphs.First()
                            .ReplaceText("مبلغ واحد ریال", "", false, RegexOptions.IgnoreCase);
                        payRow.Cells[6]
                            .Paragraphs.First()
                            .ReplaceText("مبلغ کل ریال", "", false, RegexOptions.IgnoreCase);
                        payRow.Cells[7]
                            .Paragraphs.First()
                            .ReplaceText("مبلغ تخفیف ریال", "توضیحات", false, RegexOptions.IgnoreCase);
                        payRow.Cells[8]
                            .Paragraphs.First()
                            .ReplaceText("مالیات و عوارض ریال", "", false, RegexOptions.IgnoreCase);
                        payRow.Cells[9]
                            .Paragraphs.First()
                            .ReplaceText("جمع مبلغ کل مالیات و عوارض ریال", "", false, RegexOptions.IgnoreCase);
                        ...
                        for (int i = 0; i < order.OrderPay.Count; i++)
                        {
                            ...
                            paysRow.Cells[1]
                                .Paragraphs.First()
                                .ReplaceText("کد کالا", "", false, RegexOptions.IgnoreCase);
                            paysRow.Cells[2]
                                .Paragraphs.First()
                                .ReplaceText("شرح کالا یا خدمات",
                                    order.OrderPay[i].Description,
                                    false,
                                    RegexOptions.IgnoreCase);
                            paysRow.Cells[2].Paragraphs.First().Alignment = Alignment.left;
                            paysRow.Cells[3]
                                .Paragraphs.First()
                                .ReplaceText("تعداد", "", false, RegexOptions.IgnoreCase);
                            paysRow.Cells[4]
                                .Paragraphs.First()
                                .ReplaceText("واحد", paysCell4.ToString("#,0"), false, RegexOptions.IgnoreCase);
                            paysRow.Cells[5]
                                .Paragraphs.First()
                                .ReplaceText("مبلغ واحد ریال", "", false, RegexOptions.IgnoreCase);
                            paysRow.Cells[6]
                            ...
                            paysRow.Cells[7]
                                .Paragraphs.First()
                                .ReplaceText("مبلغ تخفیف ریال", patDesc, false, RegexOptions.IgnoreCase);
                            paysRow.Cells[8]
                                .Paragraphs.First()
                                .ReplaceText("مالیات و عوارض ریال", "", false, RegexOptions.IgnoreCase);
                            paysRow.Cells[9]
                    ...
                    if (order.OrderCoupon.CouponCode != null)
                    {
                        ...
                        couponRow.Cells[2]
                            .Paragraphs.First()
                            .ReplaceText("شرح کالا یا خدمات", coupon, false, RegexOptions.IgnoreCase);
                        ...
                        couponRow.Cells[7]
                            .Paragraphs.First()
                            .ReplaceText("مبلغ تخفیف ریال", "", false, RegexOptions.IgnoreCase);
                        couponRow.Cells[8]
                            .Paragraphs.First()
                            .ReplaceText("مالیات و عوارض ریال", "", false, RegexOptions.IgnoreCase);
                        couponRow.Cells[9]
                ...
                Random random = new();
                int title = random.Next(10000, 99999);
    ...
    {
        double ghest = ((Nerkh / 1200) + (Math.Pow(1 + (Nerkh / 1200), Time) * Total)) /
                       (Math.Pow(1 + (Nerkh / 1200), Time) - 1);
        return ghest;
    }

    public double GetTotalGhest(int Total, int GhestCount, int Ghest)
    {
        double Karmozd = Total * 0.02;
    ...
    public async Task<List<OrderDto>> GetFinallyOrdersOfUser(int userId)
    {
        ...
        List<Order> orderList = await _context.Orders.Where(z => z.UserId == userId && z.IsFinaly)
            .OrderByDescending(u => u.CreateDate)
            .ToListAsync();
        foreach (Order order in orderList)
        {
            OrderDto? orderDto = _mapper.Map<OrderDto>(order);
            UserBilling? User = await _context.UserBillings.Where(a => a.UserId == order.UserId).FirstOrDefaultAsync();

            orderDto.Costumer = $"{User.FirstName} {User.LastName}";

            OrderStatus? orderStatus = await _orderStatusRepo.GetActiveOrderStatuseByOrderId(order.OrderId);
            if (orderStatus != null)
            {
    ...
    public async Task<PagingDto> GetFinallyOrdersOfUserByPaging(int Pageid = 1,
        int Take = 30,
        string Filter = "",
        int userId = 0)
    {
